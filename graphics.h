/******************************************************
 * EasyX Library for C++ (Ver:20211109)
 * https://easyx.cn
 *
 * graphics.h
...
// 普通一组
#define	BDIAGONAL_FILL		BS_HATCHED, HS_BDIAGONAL					// /// 填充
#define CROSS_FILL			BS_HATCHED, HS_CROSS						// +++ 填充
#define DIAGCROSS_FILL		BS_HATCHED, HS_DIAGCROSS					// xxx 填充 (heavy cross hatch fill)
#define DOT_FILL			(BYTE*)"\x80\x00\x08\x00\x80\x00\x08\x00"	// xxx 填充
